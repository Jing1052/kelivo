            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  row(l10n.sideDrawerChooseImage, () => _pickLocalImage(context)),
                  row(l10n.sideDrawerChooseEmoji, () => _pickEmoji(context)),
                  row(l10n.sideDrawerEnterLink, () => _inputAvatarUrl(context)),
                  row(
