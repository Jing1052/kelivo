...
class _HomePageState extends State<HomePage>
  ...
  Widget _buildMobileLayout(
    ...
    return HomeMobileScaffold(
      ...
      ccSwitchVisible: _controller.ccSwitchVisible,
      ccModeActive: _controller.ccModeActive,
      ccBridgeOnline: _controller.ccBridgeOnline,
      onToggleCcMode: () => unawaited(_controller.toggleCcMode()),
