...
import 'rooms/storybook_page.dart';
...
class StillRoomsPage extends StatelessWidget {
  ...
  static const List<_Door> _doors = [
    ...
    _Door(
      ...
      locked: true,
      asset: 'assets/clawd/icon-locked.png',
    ),
    _Door(
      'grounds',
      Lucide.Sprout,
    ...
    _Door(
      ...
      'Storybooks',
      '各个国家 · 各个时期 · 我写给你的',
      'the world, written for you',
      '每晚一个地方——我讲，你听。',
      'One place a night — I tell, you listen.',
    ),
  ];
